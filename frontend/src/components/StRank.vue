<template>
    <div class="st-home-box">
        <div style="font-size: 16px">
            <span class="total_count">年度排行</span>
        </div>
        <ol style="padding-left: 0; text-align: left;">
            <li v-for="item in data" :key="item" style="font-size: 18px; line-height: 36px;">
                {{ item.name }} - {{ transTime(item.duration) }}h
            </li>
        </ol>
        <img src="/extra-assets/imgs/st-rank-bg.png" alt="st-home-bg.png" class="bg-img">
        <div class="arrow-box">
