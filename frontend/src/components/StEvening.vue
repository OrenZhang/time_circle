<template>
    <div class="st-home-box">
        ...
        <div style="font-size: 18px">
            深夜的你仍在处理 <span class="total_count">{{ data.item_name }}</span>
        </div>
        <div>
            <div style="font-size: 16px">
                <span class="total_minute">{{ transTime2Minutes(data.item_duration) }}</span> 分钟后，停止了计时
            </div>
        </div>
        <img src="/extra-assets/imgs/st-evening-bg.png" alt="st-home-bg.png" class="bg-img">
        <div class="arrow-box">
